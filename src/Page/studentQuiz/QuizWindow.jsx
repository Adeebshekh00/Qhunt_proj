    ...
    <div className="flex flex-col items-center">
      {showStartButton && (
        <div className="text-center">
          ...
          <p className="text-sm mb-4">Time for the Quiz is no. of Ques*1min.</p>
          <p className="text-sm mb-4">You can navigate forward and backward from each ques.</p>
          <p className="text-sm mb-4">Result will be displayed at the end.</p>
          {renderExtraInfo()}
          {!startQuiz && (
            <button
